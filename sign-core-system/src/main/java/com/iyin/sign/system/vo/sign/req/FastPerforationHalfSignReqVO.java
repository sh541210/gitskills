...
/**
    ...
    */
@Data
public class FastPerforationHalfSignReqVO extends SignBaseVO implements Serializable {
    ...
    @Valid
    private List<FastPerforationHalfSignVO> list;
}
