...
public class RedisPubAndSubConfig {
    ...
    RedisMessageListenerContainer container(RedisConnectionFactory connectionFactory) {
        ...
        //订阅了一个叫chat 的通道
        MessageSub messageSub =new UserRegisterMessageSub(mailToolUtil);
        MessageListenerAdapter messageListenerAdapter = new MessageListenerAdapter(messageSub, "handlerMessage");
        messageListenerAdapter.afterPropertiesSet();
        container.addMessageListener(messageListenerAdapter, new PatternTopic(messageSub.getChannel()));
